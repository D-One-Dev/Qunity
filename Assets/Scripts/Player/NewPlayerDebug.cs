...
namespace Q3Movement
{
    ...
    /// </summary>
    [RequireComponent(typeof(NewPlayerControls))]
    public class NewPlayerDebug : MonoBehaviour
    {
        ...
        private NewPlayerControls m_Player;

        private void Start()
        {
            m_Player = GetComponent<NewPlayerControls>();
        }
